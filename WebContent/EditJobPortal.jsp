...
<%HttpSession session3 = request.getSession(); 
  ...
  <input type="submit" name="logout" value="Logout">
     ...
     String requirement=(String)session.getAttribute("requirement");
    ...
    Apply at:
     ...
     <input type="text" name="email" placeholder="<%= email%>" > <br>
      Description: 
       <br><textarea   name="description" Placeholder="<%=description%> " col="40" rows="15" style="width:595px; height:842  px;" "></textarea><br>
     Requirement:
     <br><textarea   name="requirement" Placeholder="<%=requirement%> " col="40" rows="15" style="width:595px; height:842  px;" "></textarea><br>
