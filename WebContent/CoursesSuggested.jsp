            ...
            <ul class="sidebar-nav">
               ...
               <%if(session.getAttribute("type").toString().contains("student")){ %>
                ...
                <%} %>
                 <%if(session.getAttribute("type").toString().contains("student")){ %>
                <li>
                    <a href="CheckRegistration.jsp">Register For exam</a>
                </li>
                <%} %>
...
<%HttpSession session3 = request.getSession(); 
  ...
  <input type="submit" name="logout" value="Logout">
        ...
        <div>
            ...
            <div>
            <h1>Course Seggestions</h1>
            
            <form action="ViewSuggestions.jsp" >
            <tr><b>Select Program</b><br>
				<input type="radio" name="program" value="Computer Science"> Computer Science
  				<input type="radio" name="program" value="Economics"> Economics		
  				<input type="radio" name="program" value="Management" > Management
