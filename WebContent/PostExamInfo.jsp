...
<%HttpSession session3 = request.getSession(); 
  ...
  <input type="submit" name="logout" value="Logout">
     ...
     <div>
     <h2>Create Exam</h2>
     <form action="PostExamServlet" method="post">
     <br><b>Exam name:</b>
     <input type="text" name="examName" placeholder="Enter The Exam Name">
    <br> <b>Exam Date:</b>
     <input type="date" name="examDate">
     <br><b>Exam Details:</b>
     <textarea   name="examDetails" Placeholder="Description regarding the announcement" col="40" rows="15" style="width:595px; height:842  px;" "></textarea><br>
