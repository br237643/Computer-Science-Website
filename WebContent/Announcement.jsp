        ...
        <h1>Create A New Announcement</h1>
          <form action="AnnouncementServlet" method="post" >
			...
			<br>
				...
				<br>
				Title
				<input type="textbox"  name="title" placeholder="Enter the Title of Announcements" required width="500">
				<br>
				Description
				<br><textarea   name="Description" Placeholder="Description regarding the announcement" col="40" rows="15" style="width:595px; height:842  px;" "></textarea><br>
...
<td><c:out value="${row.usermail}"/></td>
