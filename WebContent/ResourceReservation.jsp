...
<td><input type="checkbox" name="type" value="${row.name}" align="middle"></td>
  ...
  <br>
<input type="submit" name="CheckAvailable" value="Show Available Slots"/>
</form>
        </div>
