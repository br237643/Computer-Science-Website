...
<%HttpSession session3 = request.getSession(); 
  ...
  <input type="submit" name="logout" value="Logout">
    ...
    <div>
    <h1> Select The Exam to post result :</h1>
...
<td><a href="PostResultServlet?exam=${row.nameOfExam}">Post/Edit Results</a></td>
<td><a href="DeleteExamServlet?exam=${row.nameOfExam}">Delete Exam </a></td>
<%} %>
