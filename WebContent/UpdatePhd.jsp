...
<%HttpSession session3 = request.getSession(); 
  ...
  <a href="Logout.jsp">Logout</a>
        ...
        <div>
<%String netID=(String)request.getAttribute("netID");
String name=(String)request.getAttribute("name");
String status=(String)request.getAttribute("status");%>     


<form action="PhDStatusServlet" method="post">
Student Name : <%=name %>

<br>
Student Net ID : <%=netID %>

<br>
Status:
<textarea name="status" placeholder="<%=status %>"rows="13" cols="50"></textarea>
